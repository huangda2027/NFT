...
//全部
var settings = {
    "url": "http://124.221.139.228:8080/NFTFunction//searchNFTByUserId_allPass?userId=" + userId,
    "method": "GET",
    "timeout": 0,
    "headers": {
...
$.ajax(settings).done(function (response) {
    ...
    for (i = 0; i < getJsonLength(response); i++) {
        ...
        imgContainer.appendChild(hoverShow);
...
//仓库
settings = {
    "url": "http://124.221.139.228:8080/NFTFunction//searchNFTByUserId?userId=" + userId,
    "method": "Get",
    "timeout": 0,
    "headers": {
        "Content-Type": "application/json",
...
//待审核
settings = {
    "url": "http://124.221.139.228:8080/NFTFunction//searchNFTByUserId_onCheck?userId=" + userId,
    "method": "GET",
    "timeout": 0,
    "headers": {
        "Content-Type": "application/json",
...
//我喜欢
settings = {
    "url": "http://124.221.139.228:8080/NFTFunction///searchLike?userId=" + userId,
    "method": "GET",
    "timeout": 0,
    "headers": {
        "Content-Type": "application/json",
...
function pull(nftId) {
    alert("下架")
    var settings = {
        "url": "http://124.221.139.228:8080/NFTFunction/updateCondition",
        "method": "POST",
        "timeout": 0,
        "headers": {
            "Content-Type": "application/json",
...
function deleteNFT(nftId) {
    alert("删除");
    var settings = {
        "url": "http://124.221.139.228:8080/NFTFunction/deleteNFT",
        "method": "POST",
        "timeout": 0,
        "headers": {
            "Content-Type": "application/json",
