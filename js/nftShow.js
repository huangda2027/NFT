...
var settings = {
    "url": "http://localhost:8080/NFTFunction/searchNFTOnSale",
    "method": "GET",
    "timeout": 0,
  };
  ...
  $.ajax(settings).done(function (response) {
    ...
    for(var i=0;i<getJsonLength(response);i++)
    {
        ...
        likeButton.setAttribute("onclick","like("+i+","+nftId+")");
  ...
  function like(index,nftId){
    ...
    var settings = {
      ...
      $.ajax(settings).done(function (response) {
        ...
        likeButton[index].setAttribute("src","picture/redheart.png");
      });
